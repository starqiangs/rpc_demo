...
PROTOBUF_NAMESPACE_OPEN
template<> ::rpc_demo::HelloReply* Arena::CreateMaybeMessage<::rpc_demo::HelloReply>(Arena*);
template<> ::rpc_demo::HelloRequest* Arena::CreateMaybeMessage<::rpc_demo::HelloRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace rpc_demo {
...
class HelloRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:rpc_demo.HelloRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rpc_demo.HelloRequest)
 private:
  class _Internal;
...
class HelloReply final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:rpc_demo.HelloReply) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rpc_demo.HelloReply)
 private:
  class _Internal;
...
inline const std::string& HelloRequest::name() const {
  // @@protoc_insertion_point(field_get:rpc_demo.HelloRequest.name)
...
void HelloRequest::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 name_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc_demo.HelloRequest.name)
}
inline std::string* HelloRequest::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:rpc_demo.HelloRequest.name)
  return _s;
}
...
inline std::string* HelloRequest::release_name() {
  // @@protoc_insertion_point(field_release:rpc_demo.HelloRequest.name)
...
inline void HelloRequest::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:rpc_demo.HelloRequest.name)
}
...
inline const std::string& HelloReply::message() const {
  // @@protoc_insertion_point(field_get:rpc_demo.HelloReply.message)
...
void HelloReply::set_message(ArgT0&& arg0, ArgT... args) {
 ...
 message_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:rpc_demo.HelloReply.message)
}
inline std::string* HelloReply::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:rpc_demo.HelloReply.message)
  return _s;
}
...
inline std::string* HelloReply::release_message() {
  // @@protoc_insertion_point(field_release:rpc_demo.HelloReply.message)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:rpc_demo.HelloReply.message)
}
